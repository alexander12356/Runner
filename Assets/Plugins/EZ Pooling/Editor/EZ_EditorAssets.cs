    ...
    public static class EZ_EditorUtility
    {
        ...
        public static Texture LoadTexture(TextureData texData)
        {
            if (texData.tex == null)
            {
                ...
                {
                    if (!Directory.Exists("Assets/Plugins/Editor Default Resources/" + EZ_EditorAssets.assetName))
                    {
                        Directory.CreateDirectory("Assets/Plugins/Editor Default Resources/" + EZ_EditorAssets.assetName);
                    }
